...
#define SOJOURN_TARGET_0 4 * SOJOURN_TARGET_2
...
// RED 
#define MIN_DROP 8w20
#define MAX_DROP 8w100
#define NO_DROP 8w0
    ...
    apply {
        if (standard_metadata.priority != 3w7) {
            ...
            if (standard_metadata.deq_qdepth > current_queue_threshold_min){
                r_slice_drop.write((bit<32>)meta.codel.queue_id, MIN_DROP); // drop with threshold(min)
            }
