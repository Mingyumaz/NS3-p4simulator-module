...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    for (unsigned int i = 0; i < hostNum; i++) {
        ...
        std::cout << "The ip of host " << i << " is: " << hostNodes[i].hostIpv4Str << std::endl;
    }
    ...
    } else if (application == 1) // Udp Echo Client Server Application
    {
        NS_LOG_LOGIC("Application: Echo Sink");
